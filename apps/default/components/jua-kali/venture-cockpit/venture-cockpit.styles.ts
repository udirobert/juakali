...
export const styles = StyleSheet.create({
    ...
    requestRowSelected: { borderColor: color.brass, backgroundColor: "rgba(180, 135, 48, 0.08)" },
    requestInvestor: { fontFamily: font.bodyBold, fontSize: 13, fontWeight: "700", color: color.charcoal },
    requestMark: { fontFamily: font.bodyBold, fontSize: 11, fontWeight: "700", color: color.brassDeep },
